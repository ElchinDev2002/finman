...
class ShellScreen extends StatelessWidget {
  ...
  static const _sections = [
    ...
    (label: 'Income', path: '/income', icon: Icons.arrow_downward),
    (label: 'Expenses', path: '/expenses', icon: Icons.arrow_upward),
    (label: 'Accounts', path: '/accounts', icon: Icons.account_balance_wallet_outlined),
    (label: 'Budget', path: '/budget', icon: Icons.pie_chart_outline),
    (label: 'Goals', path: '/goals', icon: Icons.flag_outlined),
    (label: 'Credits', path: '/credits', icon: Icons.credit_card_outlined),
    (label: 'Subscriptions', path: '/subscriptions', icon: Icons.repeat),
